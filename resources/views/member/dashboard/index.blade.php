...
<head>
    ...
    <title>Dashboard Anggota - Library App</title>
    ...
    <div class="flex h-screen w-full relative">
        ...
        <main class="flex-1 flex flex-col h-full overflow-y-auto relative z-10 w-full">
            ...
            <div class="p-4 sm:p-8 flex flex-col gap-8 max-w-[1600px] mx-auto w-full">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 animate-enter delay-100">
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                <p
                                    class="text-primary-mid dark:text-white/60 text-sm font-medium uppercase tracking-wider">
                                    Sedang Dipinjam</p>
                                <h3 class="text-3xl font-bold text-primary-dark dark:text-white mt-1">
                                    {{ $activeLoansCount }} <span
                                        class="text-sm font-normal text-primary-mid/60">Buku</span>
                                </h3>
                            </div>
                            <div
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-primary-dark dark:text-white mt-1">
                                    {{ $pendingLoansCount }} <span
                                        class="text-sm font-normal text-primary-mid/60">Pengajuan</span>
                                </h3>
                            </div>
                            <div
                ...
                <div class="animate-enter delay-200">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="{{ route('member.buku.index') }}"
                            class="text-sm font-bold text-primary hover:underline">Lihat Semua</a>
                    </div>
                        ...
                        @foreach($recentBooks as $item)
                            <a href="{{ route('member.buku.show', $item->id_buku) }}"
                                ...
                                <div class="aspect-[2/3] relative overflow-hidden bg-slate-100 dark:bg-white/5">
                                    ...
                                    <div
                                        ...
                                        <div class="text-center text-white">
                                            <span
                                                class="material-symbols-outlined text-[32px] drop-shadow-md mb-2">auto_stories</span>
                                            <p
                                ...
                                <div class="p-4 flex flex-col flex-1">
                                    <h3
                                        class="text-sm font-bold text-primary-dark dark:text-white mb-1 line-clamp-2 leading-tight">
                                        {{ $item->judul }}
                                    </h3>
