...
@section('title', 'Katalog Buku - Library App')
@section('header-title', 'Katalog Buku')

@push('scripts')
    @vite(['resources/js/member/buku-index.js'])
@endpush
        ...
        <form method="GET" action="{{ route('member.buku.index') }}"
            ...
            <div class="relative">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari judul..."
                    class="pl-10 pr-4 py-2 rounded-xl bg-white dark:bg-surface-dark border border-primary/20 dark:border-white/10 text-primary-dark dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 w-full md:w-64">
            </div>
        </form>
    </div>

    <!-- Grid Buku -->
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 animate-enter delay-100 pb-10">
                ...
                <div class="aspect-[2/3] relative overflow-hidden bg-slate-100 dark:bg-white/5">
                    ...
                    @if($item->gambar_sampul)
                        <div class="w-full h-full relative group-hover:scale-105 transition-transform duration-500">
                            <img src="{{ asset('storage/' . $item->gambar_sampul) }}" alt="{{ $item->judul }}"
                    ...
                    @else
                        <div
                            ...
                            <div
                                ...
                                <span class="material-symbols-outlined text-[48px] drop-shadow-md">auto_stories</span>
                                <p
                ...
                <div class="p-5 flex flex-col flex-1 bg-white dark:bg-surface-dark relative">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            @else
                                <span class="text-red-500 font-bold uppercase tracking-tight flex items-center gap-1">
        ...
        @empty
            <div class="col-span-full flex flex-col items-center justify-center py-20 text-center">
                <div class="bg-primary/5 dark:bg-white/5 p-8 rounded-full mb-4 animate-pulse">
                    <span class="material-symbols-outlined text-[48px] text-primary-mid dark:text-white/40">library_books</span>
                </div>
