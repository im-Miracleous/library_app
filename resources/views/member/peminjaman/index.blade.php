...
<head>
    ...
    <title>Riwayat Transaksi - Library App</title>
...
<body class="bg-background-light dark:bg-background-dark text-slate-700 dark:text-white font-display overflow-hidden">
    <div class="flex h-screen w-full relative">
        ...
        <main class="flex-1 flex flex-col h-full overflow-y-auto relative z-10 w-full">
            <x-header-component title="Riwayat Transaksi" />

            <div class="p-4 sm:p-8 max-w-6xl mx-auto w-full animate-enter">

                <!-- Tabs -->
                <div
                    class="flex items-center gap-2 mb-8 bg-white dark:bg-surface-dark p-1 rounded-2xl w-fit shadow-sm border border-primary/10 dark:border-white/5">
                                        ...
                                        <div class="flex flex-col gap-1">
                                            @foreach($loan->details as $detail)
                                                <div class="text-xs text-slate-700 dark:text-white/80 flex items-center gap-2">
                                                    <span
                                                        class="material-symbols-outlined text-[16px] text-primary/60">menu_book</span>
                                                    <div>
                                                        <span
                                    ...
                                    <td colspan="5" class="p-8 text-center text-slate-500 dark:text-white/60">
                                        <div class="flex flex-col items-center justify-center">
                                            <div class="bg-primary/5 dark:bg-white/5 p-4 rounded-full mb-3">
                                                <span
                                                    class="material-symbols-outlined text-[32px] opacity-50">history_edu</span>
                                            </div>
