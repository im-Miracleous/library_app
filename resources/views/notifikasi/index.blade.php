                        ...
                        <div class="p-5 bg-blue-50/70 dark:bg-blue-900/10 border-b border-blue-100 dark:border-blue-900/30">
                            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                <div class="flex gap-4">
                                    <div class="shrink-0">
                                        <div
                                            class="size-12 rounded-2xl bg-blue-600 text-white flex items-center justify-center shadow-lg shadow-blue-500/30">
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2 mb-1">
                                            ...
                                            <span
                                                class="bg-blue-600 text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">PENTING</span>
                                        </div>
                        ...
                        <div
                            ...
                            <div class="shrink-0 mt-1">
                                ...
                                @elseif($ntype == 'success')
                                    <div
                                        class="size-10 rounded-full bg-emerald-100 dark:bg-emerald-500/20 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
                                        <span class="material-symbols-outlined">{{ $nicon }}</span>
                                    </div>
                                @elseif($ntype == 'info')
                                    <div
